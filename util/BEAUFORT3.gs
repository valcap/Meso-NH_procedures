...
'set rgb 80 255   0   0'
'set rgb 92 180 180 255'
'set rgb 96 255   0 255'
'set rgb 97 255 170 255'
'set rgb 98 255 150   0'
'set rgb 99 245 255 255'

*personali   
'set rgb 81 245 255 255'
'set rgb 82 150 210 250'
'set rgb 83  80 165 245'
'set rgb 84  25 110 225'
'set rgb 85   0 210 120'
'set rgb 86   0 160   0'
'set rgb 87 225  20   0'
'set rgb 88 165   0   0'
'set rgb 89 255   0 255'
'set rgb 90 255 170 255'
'set rgb 91 255 150   0'
'set rgb 93 249 100   1'


'set rgb 82 203 241 250'

'set ccols 81 82 83 84 85 86 87 88 89 90 91 93 15 '


*km/h
'set clevs 19 30 39 50 61 74 87 102 117'
'set ccols 81 85 86 87 88 89 90 91 93 15 '
